window.CS336_EN = Object.freeze({
  ...
  "labs": {
    "shapes": {
      ...
      "transferAnswer": "If only T doubles, activations like B×T×D as well as Q, K, and V with B×H×T×d_head become twice as long along the sequence axis. In contrast, attention scores with B×H×T×T contain four times as many elements because both position axes grow. Parameter counts like V×D for the embedding or D×D_out for weight matrices remain unchanged, as trainable matrices do not depend on the length of a specific input sequence."
    },
    "bpe": {
    ...
    "resources": {
      ...
      "desc": "Estimate model size, AdamW state, activations, and training time.",
    ...
    "grpo": {
      ...
      "desc": "Vary group rewards, baseline, and normalization; observe learning signal and variance.",
